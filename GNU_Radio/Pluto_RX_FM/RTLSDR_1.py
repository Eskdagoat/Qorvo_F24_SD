...
class RTLSDR_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RTLSDR_1")
        ...
        self._freq_range = qtgui.Range(87e6, 107e6, 200e3, 100e6, 200)
...
def main(top_block_cls=RTLSDR_1, options=None):
