...
HD_PWD='B:/OneDrive/OneDrive/_School/QORVO_RADIO/Github/Qorvo_F24_SD/SD1_Fall24/Computer/Eclypse/Eclypse_Test_PLL_1/Eclypse_Test_PLL_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockDivider_Block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ClockDivider_Block_wrapper.tcl -notrace
