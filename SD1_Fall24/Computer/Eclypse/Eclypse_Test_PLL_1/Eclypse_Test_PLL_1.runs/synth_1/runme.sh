...
HD_PWD='C:/Users/ambsc/OneDrive/_School/QORVO_RADIO/Github/Qorvo_F24_SD/SD1_Fall24/Computer/Eclypse/Eclypse_Test_PLL_1/Eclypse_Test_PLL_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockDivider_Block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockDivider_Block_wrapper.tcl
