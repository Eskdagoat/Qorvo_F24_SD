...
EAStep vivado -log ClockDivider_Block_ClockDivider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockDivider_Block_ClockDivider_0_0.tcl
