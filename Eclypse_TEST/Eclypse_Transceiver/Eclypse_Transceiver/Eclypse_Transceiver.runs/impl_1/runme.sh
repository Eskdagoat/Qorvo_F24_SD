...
HD_PWD='B:/OneDrive/OneDrive/_School/QORVO_RADIO/Github/Qorvo_F24_SD/Eclypse_TEST/Eclypse_Transceiver/Eclypse_Transceiver/Eclypse_Transceiver.runs/impl_1'
cd "$HD_PWD"
