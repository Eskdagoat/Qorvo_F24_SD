...
class QR_Eclypse_IQ(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "QR_Eclypse_IQ")
        ...
        self._rx_baseband_range = qtgui.Range(1000000, 80000000, 100000, 47000000, 200)
        self._rx_baseband_win = qtgui.RangeWidget(self._rx_baseband_range, self.set_rx_baseband, "Frequency (Hz)", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.eclypse_z7_qr_source_0_0 = eclypse_z7_qr.source(addr, 1002, rx_freq, rx_samp_rate, 0)
        self.eclypse_z7_qr_source_0 = eclypse_z7_qr.source(addr, 1001, rx_freq, rx_samp_rate, 0)
        ...
        self.connect((self.eclypse_z7_qr_source_0, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.eclypse_z7_qr_source_0_0, 0), (self.blocks_float_to_complex_0, 1))
    ...
    def set_rx_samp_rate(self, rx_samp_rate):
        ...
        self.eclypse_z7_qr_source_0.set_rate(self.rx_samp_rate)
        self.eclypse_z7_qr_source_0_0.set_rate(self.rx_samp_rate)
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.eclypse_z7_qr_source_0.set_freq(self.rx_freq, 0)
        self.eclypse_z7_qr_source_0_0.set_freq(self.rx_freq, 0)
        self.qtgui_sink_x_0.set_frequency_range((self.rx_freq*1000000), self.rx_samp_rate)
...
def main(top_block_cls=QR_Eclypse_IQ, options=None):
