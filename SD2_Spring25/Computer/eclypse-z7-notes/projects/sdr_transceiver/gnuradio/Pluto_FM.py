...
class Pluto_FM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QORVO_RADIO", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QORVO_RADIO")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Pluto_FM")
        ...
        self.freq = freq = 462750000

        ##################################################
        # Blocks
        ##################################################

        self._freq_range = qtgui.Range(460000000, 465000000, 50000, 462750000, 200)
        ...
        self.analog_simple_squelch_cc_0 = analog.simple_squelch_cc(0, 0.1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 44.1e3, 44.1e3, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Pluto_FM, options=None):
